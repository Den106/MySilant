...
class TypeOfRefusalViewSet(viewsets.ModelViewSet):
    permission_classes = (DjangoModelPermissions,)
    serializer_class = TypeOfRefusalSerializer
    http_method_names = ('get',)
    queryset = TypeOfRefusal.objects.all()
    
    
class MethodOfRepairViewSet(viewsets.ModelViewSet):
    permission_classes = (DjangoModelPermissions,)
    serializer_class = MethodOfRepairSerializer
    http_method_names = ('get',)
    queryset = MethodOfRepair.objects.all()